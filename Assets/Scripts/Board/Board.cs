...
public class Board : NetworkBehaviour
{
    ...
    public void GenerateBoard()
    {
        ...
        for(int i = 0; i < outLinePositions.Length * 2; i++)
        {
            ...
            {                    
                ...
                {
                    // 왼쪽 오른쪽
                    CreateCell(CellType.Breakable, block[0],
    ...
    private void CreateCell(CellType type, GameObject obj, Vector3 position, string name = "Cell_Unknown", Transform parent = null)
    {
